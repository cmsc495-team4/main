...
function getDropDown($fieldName, $tableName, $previousValue)
{
    ...
    if ($skipRest != "true") {
    	...
    	if (!empty($previousValue)) {
    		echo "<option name=\"" . $fieldName . "\"value=\"" . $previousValue . "\" selected>- select -</option>\n";
    	}
    	else {
			echo "<!-- *** dropdown box \"<option>\" values are auto-generated by code -->\n";
			echo "<option name=\"" . $fieldName . "\"value=\"0000\" selected>- select -</option>\n";
        }
...
function getInvestigators()
{
    ...
    if ($skipRest != "true") {
        echo "<!-- *** dropdown box \"<option>\" values are auto-generated by code -->\n";
        echo "<option name=\"pi_name\" value=\"none\" selected>- select -</option>\n";

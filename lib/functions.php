...
function getAnimal($selectedUpdateValue)
{
    ...
    global $animalID, $tagNumber, $sex, $strain, $species, $classification, $genotype, $birth_date, $wean_date, $tag_date, $deceased, $transferred, $comments, $responsible_PI, $strain_ID, $firstName, $lastName, $litterID, $location, $parentPair;
